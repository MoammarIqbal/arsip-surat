...
<body class="min-h-screen">
  ...
  <!-- Global loader -->
  <div id="app-loader"><div class="spinner" aria-label="Loading..."></div></div>
  ...
  <nav class="nav">
    <div class="max-w-6xl mx-auto px-4">
      <div class="flex h-14 items-center justify-between">
        <!-- Brand -->
        <a href="{{ route('surat.index') }}" class="flex items-center gap-2 font-bold">
          <img src="https://i.ibb.co/L8s39sV/Transfer-Ku-Logo.png" class="h-8" alt="Logo">
        ...
        <div class="hidden md:flex items-center justify-end gap-1 nav-inner">
          ...
          <a href="{{ route('users.index') }}" id="menu-admin-desktop" class="nav-link hidden" data-path="/users">Manajemen User</a>
          ...
          <div class="relative ml-2">
            ...
            <div id="user-dropdown" class="dropdown hidden absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border p-2">
      ...
      <div class="px-4 py-3 drawer">
        <div class="flex items-center justify-between pb-2 mb-2 border-b">
          <div class="flex items-center gap-2">
            <div class="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-700 font-bold">U</div>
            <div>
        ...
        <nav class="flex flex-col gap-1">
          <a href="{{ route('surat.index') }}" class="nav-link" data-path="/surat">Daftar Surat</a>
          <a href="{{ route('surat.create') }}" class="nav-link" data-path="/surat/tambah">Tambah Surat</a>
          <a href="{{ route('users.index') }}" id="menu-admin-mobile" class="nav-link hidden" data-path="/users">Manajemen User</a>
        </nav>
      </div>
    </div>
  </nav>
